...
<head>
    ...
    <title>Codeigniter4 and angularjs</title>
    <!-- loader-->
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="index.html">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Unit Kerja</span>
                    </a>
                </li>
                <li>
                    <a href="index.html">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Surat Masuk</span>
                    </a>
                </li>
                <li>
                    <a href="index.html">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Surat Keluar</span>
                    </a>
                </li>
            </ul>
